...
def main():
    ...
    player = Entity(0, 0, '@', libtcod.white, 'Playa', blocks=True, render_order=RenderOrder.ACTOR, fighter=fighter_component, inventory=inventory_component)
    entities = [player]
    ...
    while not libtcod.console_is_window_closed():
        ...
        if move and game_state == GameStates.PLAYER_TURN:
            ...
            if not game_map.is_blocked(destination_x, destination_y): #is this new space a wall? 
